...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BottomSheetDetailComponent = /** @class */ (function () {
                function BottomSheetDetailComponent(bottomSheetRef, data) {
                    this.bottomSheetRef = bottomSheetRef;
                    this.data = data;
                }
                BottomSheetDetailComponent.prototype.ngOnInit = function () { };
                return BottomSheetDetailComponent;
            }());
            BottomSheetDetailComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetectorComponent = /** @class */ (function () {
                function DetectorComponent(dialog, predictionService, http) {
                    this.dialog = dialog;
                ...
                DetectorComponent.prototype.loadModel = function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.model.loadModelAsync(this.modelEndpoint)];
                                case 1:
                                    _a.sent();
                                    this.http
                                        ...
                                        _this.file = result;
                                        for (var _i = 0, _a = _this.file.split(/[\r\n]+/); _i < _a.length; _i++) {
                                            var line = _a[_i];
                                            _this.labl.push(line);
                                        }
                                    });
                ...
                DetectorComponent.prototype.initStreamDetection = function () {
                    var _this = this;
                    if (this.stream === null) {
                        this.startStream();
                        if (this.detectId === null) {
                            // detection interval: default 3000
                            this.detectId = setInterval(function () {
                                // state still registering
                                if (!_this.stateContainer) {
                ...
                DetectorComponent.prototype.detectObjects = function () {
                    this.clearOverlay();
                ...
                DetectorComponent.prototype.clearOverlay = function () {
                    this.ctx.clearRect(0, 0, this.overlay.nativeElement.width, this.overlay.nativeElement.height);
                };
                DetectorComponent.prototype.drawOverlay = function (x, y, w, h, title) {
                ...
                DetectorComponent.prototype.opencam = function () {
                    var _this = this;
                    navigator.mediaDevices
                        .enumerateDevices()
                        .then(function (d) {
                        _this.selectors = _this.getCaptureDevices(d);
                        _this.initStreamDetection();
                    })
                        .catch(this.handleError);
                };
                /* Start or restart the stream using a specific videosource and inject it in a container */
                DetectorComponent.prototype.startStream = function (videoSource) {
                    var _this = this;
                    if (videoSource === void 0) { videoSource = null; }
                    if (navigator.mediaDevices) {
                        if (this.selectors.map(function (s) { return s.id; }).indexOf(this.videoSource) === -1) {
                        ...
                        navigator.mediaDevices
                            ...
                            _this.stream = stream;
                            _this.alertContainer = false;
                            // on getUserMedia
                            _this.video.nativeElement.srcObject = stream;
                            _this.video.nativeElement.play();
                            // set canvas size = video size when known
                            _this.video.nativeElement.addEventListener("loadedmetadata", function () {
                                // overlay
                                _this.overlay.nativeElement.width =
                                    _this.video.nativeElement.videoWidth;
                                _this.overlay.nativeElement.height =
                                    _this.video.nativeElement.videoHeight;
                            });
                        })
                            // permission denied:
                            .catch(function (error) {
                            console.log("Camera init failed : " + error.name);
                            _this.alertContainer = true;
                            _this.alertMessage =
                ...
                DetectorComponent.prototype.getCaptureDevices = function (deviceInfos) {
                ...
                DetectorComponent.prototype.imageCapture = function (video) {
                ...
                DetectorComponent.prototype.imageDetectionOnline = function (canvas) {
                    var _this = this;
                    console.log("Working online");
                    canvas.toBlob(function (blob) {
                        var detection$;
                        if (_this.isStoringImage) {
                            detection$ = _this.predictionService.predictImage(blob, _this.customVisionEndpoint, _this.customVisionKey);
                        }
                        else {
                            detection$ = _this.predictionService.predictImageWithNoStore(blob, _this.customVisionEndpoint, _this.customVisionKey);
                        }
                        detection$.subscribe(function (predictions) {
                            predictions.predictions.forEach(function (p) {
                                if (p.tagName == _this.Filter || "" || " ")
                                    if (p.probability >= _this.confidence / 100) {
                                        _this.drawOverlay(p.boundingBox.left * _this.overlay.nativeElement.width, p.boundingBox.top * _this.overlay.nativeElement.height, p.boundingBox.width * _this.overlay.nativeElement.width, p.boundingBox.height * _this.overlay.nativeElement.height, p.tagName);
                                        console.log(p.tagName + " " + p.probability * 100 + " % ");
                                        if (p.tagName == _this.Filter || "" || " ") {
                                            _this.http.post(_this.URLApi, { deviceID: "Cam1", alertType: p.tagName, metaData: _this.Metadata }).subscribe(function (res) {
                                            });
                                        }
                                    }
                            });
                ...
                DetectorComponent.prototype.imageDetectionLocal = function (canvas) {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var result, index, w, h;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!this.loadedModel) return [3 /*break*/, 2];
                                    console.log("Working offline");
                                    return [4 /*yield*/, this.model.executeAsync(canvas)];
                                case 1:
                                    result = _a.sent();
                                    // tslint:disable-next-line: prefer-for-of
                                    for (index = 0; index < result[0].length; index++) {
                                        if (result[1][index] > 0.4) {
                                            w = result[0][index][2] * this.overlay.nativeElement.width -
                                                result[0][index][0] * this.overlay.nativeElement.width;
                                            h = result[0][index][3] * this.overlay.nativeElement.height -
                ...
                DetectorComponent.prototype.stopCaptureStream = function () {
                    // stop camera capture
                    if (this.stream) {
                ...
                DetectorComponent.prototype.handleError = function (error) {
                    console.log("navigator.getUserMedia error: ", error);
                };
                DetectorComponent.prototype.ngOnDestroy = function () {
            ...
            DetectorComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SettingsComponent = /** @class */ (function () {
                ...
                SettingsComponent.prototype.updateSetting = function (event) {
                    this.confidence = event.value;
                };
                SettingsComponent.prototype.setEndpointsAndKey = function () {
                    var settings = {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TestLocalComponent = /** @class */ (function () {
                function TestLocalComponent() {
                }
                TestLocalComponent.prototype.ngOnInit = function () {
                    this.launchModel();
                };
                TestLocalComponent.prototype.launchModel = function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                        var model, image, result;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    model = new _microsoft_customvision_tfjs__WEBPACK_IMPORTED_MODULE_2__["ObjectDetectionModel"]();
                                    return [4 /*yield*/, model.loadModelAsync("http://localhost:4200/assets/model.json")];
                                case 1:
                                    _a.sent();
                                    console.log(model);
                                    image = document.getElementById("image");
                                    return [4 /*yield*/, model.executeAsync(image)];
                                case 2:
                                    result = _a.sent();
                                    console.log(result);
                                    return [2 /*return*/];
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Objects = /** @class */ (function () {
                function Objects(label, description) {
                    this.image = null;
                    this.label = label;
